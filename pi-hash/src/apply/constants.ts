...
export const APPLY_PATCH_PROMPT_INSTRUCTIONS = [
  ...
  "",
  "### Edit Hunks",
  "Each edit hunk MUST start with @@ (optionally @@ <context>). Hunk lines MUST start with one of the following prefixes:",
  "- Edit context (' ') and removal ('-') lines MUST use LINEHASH|CONTENT anchors.",
  "- Edit addition ('+') lines MUST NOT include LINEHASH prefixes.",
  "- ' ' for context",
  "- '-' for removed line",
  "- '+' for added line",
  "",
