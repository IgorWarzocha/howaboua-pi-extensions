      ...
      if (normalizedFiles.length === 0) {
        return {
          content: [
            {
              type: "text",
              text: "Invalid input: no readable files were provided. You MUST provide at least one file path. You SHOULD use a MULTI-READ 'files' array for related files.",
            },
          ],
          isError: true,
          details: { files: [] },
