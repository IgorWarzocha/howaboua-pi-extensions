...
agent_rules: "MUST follow RFC 2119 language. MUST NOT change status unless user explicitly requests closure. MUST update checklist done booleans while working. MUST treat linked files as REQUIRED reading before implementation. MUST NOT create checklist items for type=prd or type=spec."
worktree:
  enabled: true
